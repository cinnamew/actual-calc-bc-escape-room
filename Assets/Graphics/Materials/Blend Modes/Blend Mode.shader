// Sprite lit default shader but with adjustable srcMode, dstMode, and blendOp

Shader "Custom/Blend Mode"
{
    Properties
    {
        ...
        // [KeywordEnum(LighterColor, Exclusion)] _BlendMode("Blend Mode", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // #pragma multi_compile _BLENDMODE_LIGHTERCOLOR _BLENDMODE_EXCLUSION
